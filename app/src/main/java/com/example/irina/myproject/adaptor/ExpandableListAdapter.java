...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private HashMap<String, List<String>> listDataChild; // date din child sub forma unui hash map (header title, child title)
    ...
    public int getChildrenCount(int groupPosition) {
        if (this.listDataChild.get(
                this.listDataHeader.get(groupPosition)) == null) {
            return 0;
